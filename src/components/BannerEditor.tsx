...
=======
      ...
      textElements.forEach((element) => {
        ...
        // 구성에 정의된 lineHeight 우선 사용
        const configLineHeight = (() => {
          if (element.id === 'sub-title' && selection.config.subTitle?.lineHeight) return selection.config.subTitle.lineHeight;
          if (element.id === 'main-title' && selection.config.mainTitle?.lineHeight) return selection.config.mainTitle.lineHeight;
          if (element.id === 'bottom-sub-title' && selection.config.bottomSubTitle?.lineHeight) return selection.config.bottomSubTitle.lineHeight;
          if (element.id === 'button-text' && selection.config.buttonText?.lineHeight) return selection.config.buttonText.lineHeight;
          return undefined;
        })();
